export const Work = [
   ...
   {
      id:2,
      name:"Syrup Favtory Website - v1. DEMO",
      description:"Local syrup factory presentation website. Mobile first projected",
      tags:["html","css","javascript"],
      demo:"https://cosminghirisan.github.io/greenEssentials/",
      github:"https://github.com/CosminGhirisan/greenEssentials"
   },
   {
      id:1,
      name:"Client View Design - DEMO",
      description:"Demo for a client side web app, without any functionalities, only design. Fully responsive",
      tags:["html","scss","bootstrap"],
      demo:"https://cosminghirisan.github.io/clientview/",
      github:"https://github.com/CosminGhirisan/clientview/"
   }
]